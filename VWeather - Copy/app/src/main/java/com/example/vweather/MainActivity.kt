    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // hourlyweatherTask().execute()
        ...
        executor.execute {
            ...
            val response1: String = URL("https://pro.openweathermap.org/data/2.5/weather?q=london&units=metric&lang=vi&appid=$API").readText(
                Charsets.UTF_8)
            ...
            handler.post {
                findViewById<TextView>(R.id.city_name_text).text=cityName
                findViewById<TextView>(R.id.temp).text=temp
                findViewById<TextView>(R.id.date_time).text= dateTime
                findViewById<TextView>(R.id.city_name_text).text= cityName
            }
        }
    ...
    inner class hourlyweatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                findViewById<TextView>(R.id.temp_hourly1).text =
                    findViewById<TextView>(R.id.temp).text.toString()
                ...
                findViewById<TextView>(R.id.temp_hourly10).text =
                    df.format(temp10.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly11).text =
                    df.format(temp11.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly12).text =
                    df.format(temp12.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly13).text =
                    df.format(temp13.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly14).text =
                    df.format(temp14.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly15).text =
                    df.format(temp15.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly16).text =
                    df.format(temp16.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly17).text =
                    df.format(temp17.toDouble()) + "°C"
                findViewById<TextView>(R.id.temp_hourly18).text =
                    df.format(temp18.toDouble()) + "°C"
                ...
                val time_hourly10 =
                    jsonObj.getJSONArray("list").getJSONObject(10).getString("dt_txt")
                val time_hourly11 =
                    jsonObj.getJSONArray("list").getJSONObject(11).getString("dt_txt")
                val time_hourly12 =
                    jsonObj.getJSONArray("list").getJSONObject(12).getString("dt_txt")
                val time_hourly13 =
                    jsonObj.getJSONArray("list").getJSONObject(13).getString("dt_txt")
                val time_hourly14 =
                    jsonObj.getJSONArray("list").getJSONObject(14).getString("dt_txt")
                val time_hourly15 =
                    jsonObj.getJSONArray("list").getJSONObject(15).getString("dt_txt")
                val time_hourly16 =
                    jsonObj.getJSONArray("list").getJSONObject(16).getString("dt_txt")
                val time_hourly17 =
                    jsonObj.getJSONArray("list").getJSONObject(17).getString("dt_txt")
                val time_hourly18 =
                    jsonObj.getJSONArray("list").getJSONObject(18).getString("dt_txt")
                ...
                findViewById<TextView>(R.id.time_hourly2).text = SimpleDateFormat("HH:mm").format(
                    time2
                )
                findViewById<TextView>(R.id.time_hourly3).text = SimpleDateFormat("HH:mm").format(
                    time3
                )
                findViewById<TextView>(R.id.time_hourly4).text = SimpleDateFormat("HH:mm").format(
                    time4
                )
                findViewById<TextView>(R.id.time_hourly5).text = SimpleDateFormat("HH:mm").format(
                    time5
                )
                findViewById<TextView>(R.id.time_hourly6).text = SimpleDateFormat("HH:mm").format(
                    time6
                )
                findViewById<TextView>(R.id.time_hourly7).text = SimpleDateFormat("HH:mm").format(
                    time7
                )
                findViewById<TextView>(R.id.time_hourly8).text = SimpleDateFormat("HH:mm").format(
                    time8
                )
                findViewById<TextView>(R.id.time_hourly9).text = SimpleDateFormat("HH:mm").format(
                    time9
                )
                findViewById<TextView>(R.id.time_hourly10).text = SimpleDateFormat("HH:mm").format(
                    time10
                )
                findViewById<TextView>(R.id.time_hourly11).text = SimpleDateFormat("HH:mm").format(
                    time11
                )
                findViewById<TextView>(R.id.time_hourly12).text = SimpleDateFormat("HH:mm").format(
                    time12
                )
                findViewById<TextView>(R.id.time_hourly13).text = SimpleDateFormat("HH:mm").format(
                    time13
                )
                findViewById<TextView>(R.id.time_hourly14).text = SimpleDateFormat("HH:mm").format(
                    time14
                )
                findViewById<TextView>(R.id.time_hourly15).text = SimpleDateFormat("HH:mm").format(
                    time15
                )
                findViewById<TextView>(R.id.time_hourly16).text = SimpleDateFormat("HH:mm").format(
                    time16
                )
                findViewById<TextView>(R.id.time_hourly17).text = SimpleDateFormat("HH:mm").format(
                    time17
                )
                findViewById<TextView>(R.id.time_hourly18).text = SimpleDateFormat("HH:mm").format(
                    time18
                )
            } catch (e: Exception) {
